...
app.expandControllerInvoiceView = function ($scope, AJService, $window) {


    $scope.InvoiceViewPermissionsOutBound = function (Id) {
        ...
        EditPermissionsOutBoundDetailStatus.then(function (msg) {
            if (msg != null) {
                ...
                $scope.InvoiceCurrencySymbolView = (msg.data._GetPermissionsOutBound[0].InvoiceCurrencySymbol == null ? 'inr' : msg.data._GetPermissionsOutBound[0].InvoiceCurrencySymbol.toLowerCase());
                ...
                $scope.WorkingProductView = (msg.data._GetPermissionsOutBound[0].WorkingProduct == null ? '---' : msg.data._GetPermissionsOutBound[0].WorkingProduct);
                $scope.AuthorNameView = (msg.data._GetPermissionsOutBound[0].AuthorName == null ? '---' : msg.data._GetPermissionsOutBound[0].AuthorName);
                ...
                $scope.PermissionsoutboundId = Id;
