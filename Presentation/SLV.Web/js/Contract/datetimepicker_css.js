var winCal; var dtToday; var Cal; var MonthName; var WeekDayName1; var WeekDayName2; var exDateTime; var selDate; var calSpanID = "calBorder"; var domStyle = null; var cnLeft = "0"; var cnTop = "0"; var xpos = 0; var ypos = 0; var calHeight = 0; var CalWidth = 208; var CellWidth = 30; var TimeMode = 24; var StartYear = 1940; var EndYear = 5; var CalPosOffsetX = -1; var CalPosOffsetY = 0; var SpanBorderColor = "#000000"; var SpanBgColor = "#FFFFFF"; var MonthYearColor = "#000"; var WeekHeadColor = "#fff"; var SundayColor = "#fff"; var SaturdayColor = "#fff"; var WeekDayColor = "#fff"; var FontColor = "blue"; var TodayColor = "#3276b1"; var SelDateColor = "#eee"; var YrSelColor = "#000"; var MthSelColor = "#000"; var HoverColor = "#eee"; var DisableColor = "#eee"; var CalBgColor = "#ffffff"; var WeekChar = 2; var DateSeparator = "/"; var ShowLongMonth = true; var ShowMonthYear = true; var ThemeBg = ""; var PrecedeZero = true; var MondayFirstDay = true; var UseImageFiles = true; var imageFilesPath = "images2/"; var MonthName = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]; var WeekDayName1 = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]; var WeekDayName2 = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]; function Calendar(pDate, pCtrl)
...
{
    vCalTime += "\n<tr>\n<td colspan='7' style=\"text-align:right;\">"; if (UseImageFiles) { vCalClosing += "<i class='fa fa-times' aria-hidden='true' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='color:gray' ></i></td>"; }
...
function NewCssCal(pCtrl1, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds, pEnableDateMode)
{
    var tagname = document.getElementById(pCtrl1.id).tagName
    if (tagname == "SPAN")
    {
        pCtrl = $(document.getElementById(pCtrl1.id).closest("div")).find("input[type=text]")[0].id;
    }
    else
    {
        pCtrl = pCtrl1.id;
...
if (document.getElementById(pCtrl) == null) {
...
function selectDate(element, date) {
    Cal.Date = date; selDate = new Date(Cal.Year, Cal.Month, Cal.Date); element.style.background = SelDateColor; RenderCssCal();
}
function pickIt(evt)
