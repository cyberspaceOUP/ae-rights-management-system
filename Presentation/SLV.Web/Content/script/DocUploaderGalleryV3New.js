...
(function ($) {
   var settings;
   $.fn.multfileUpload = function (options) {
    ...
    function laksUploadInit1() {
        ...
        if (settings.fileUploadControlId != null && typeof settings.fileUploadControlId !== "undefined" && $(settings.fileUploadControlId).length > 0) {
            ...
            $(settings.fileUploadControlId).bind("change", function () {
                fn_NewUploadlaksUploadsChange(this);
            })
        ...
        if (FUControlExists == false) {
            ...
            $("#div_laksDocUploader" + totalImgUploader.toString()).append("<input id='inp_laksDocUploader" + totalImgUploader.toString() + "' type='file' value='Upload'" +
                                                    ...
                                                    " onchange='return fn_NewUploadlaksUploadsChange(this);'" +
        ...
        //debugger;
        $(settings.triggeringDom).data("NewMultipleuploadOptionDate", settings);
    }
    function fn_CreateDragNDrop1() {
...
function fn_OnDrop(e) {
    ...
    e.stopPropagation();
    //debugger;
    var crrntNewAllSettings = $(triggererDom).data("NewMultipleuploadOptionDate");
    if (crrntNewAllSettings.multiFile == false && FilesFromDropEvent.length > 1) {
    ...
    fn_NewtriggerUpload(triggererDom);
}

function fn_HandleWindowResizeForDragNDrop() {
    $(totalLakTrigrngDom).each(function () {
        //debugger;
        var DragNDropSettings = $(this).data("NewMultipleuploadOptionDate");
        ...
        //debugger;
        $(this).data("NewMultipleuploadOptionDate", DragNDropSettings);
    });
}

function fn_NewtriggerUpload(NewUploadTrigger) {
    debugger
   

    crrnt_triggeringDom = NewUploadTrigger;
    NewAllSettings = $(NewUploadTrigger).data("NewMultipleuploadOptionDate");

  
    if (NewAllSettings.onUpClick != null && typeof NewAllSettings.onUpClick !== "undefined") {
        NewAllSettings.onUpClick(NewUploadTrigger);
    }
    if (NewAllSettings.replaceLast == true && NewAllSettings.multiFile == false && NewAllSettings.progressBars != null && NewAllSettings.progressBars.length > 0) {
        if (!confrmAutoDelete) {
            alert("This will delete old upload").set("onok", function () {
                confrmAutoDelete = true
                fn_NewtriggerUpload(NewUploadTrigger);
            });
            if (DropEvent != null) {
                DropEvent.preventDefault();
            }
        ...
        if (confrmAutoDelete) {
            if (typeof NewAllSettings.containerElement !== "undefined" && $(NewAllSettings.containerElement).length > 0) {
                $(NewAllSettings.containerElement).html("");
            }
            $(NewAllSettings.progressBars).find(".crossUpload").trigger("click");
        }
        else {
    ...
    if (!NewAllSettings.isMobile && DropEvent == null) {
        $(NewAllSettings.fileUploadControlId).trigger("click");
    }
    else if (!NewAllSettings.isMobile && DropEvent != null) {
        fn_NewUploadlaksUploadsChange($(NewAllSettings.fileUploadControlId)[0]);
    }
}

function fn_NewUploadlaksUploadsChange(crrnt_Uploader) {
    
    if (NewAllSettings.onBegin != null && typeof NewAllSettings.onBegin !== "undefined") {
        NewAllSettings.onBegin(NewAllSettings);
    ...
    if (typeof containerElement !== "undefined" && typeof elementIdentifier !== "undefined") {
        ...
        if (typeof NewAllSettings !== "undefined") {
            ...
            if (NewAllSettings.multiFile == false && totalFiles > 1) {
                alert("Upload single file only");
                if (DropEvent != null) {
                    DropEvent.preventDefault();
                }
            ...
            for (indx = 0; indx < totalFiles; indx++) {
                ...
                var allowedExtension = (NewAllSettings.allowedExtensions == null ? extn : NewAllSettings.allowedExtensions).toLowerCase().split(",");
                ...
                if (typeof crrnt_FileSize !== "undefined" && NewAllSettings.fileSize > -1 && (crrnt_FileSize / (1024 * 1024)) > NewAllSettings.fileSize) {
                    var ShowDataLimit = (NewAllSettings.fileSize < 1 ? NewAllSettings.fileSize * 1000 + " KB" : NewAllSettings.fileSize + " MB");
            ...
            for (indx = 0; indx < totalFiles; indx++) {
                if (NewAllSettings.onEachFile != null && typeof NewAllSettings.onEachFile !== "undefined") {
                    NewAllSettings.onEachFile(NewAllSettings, indx);

                }
                var progressBarElement = $("<div></div>",
                                        {
                                            "class": "progresstable" + (NewAllSettings.progressBarClass != null ? " " + NewAllSettings.progressBarClass : ""),
                ...
                $(progressBarElement).data("triggeringDom", NewAllSettings.triggeringDom);
                if (NewAllSettings.progressBarContainer == null) {
                    ...
                    $(NewAllSettings.progressBarContainer).append(progressBarElement);
                    $(NewAllSettings.progressBarContainer).append("<div class='uploadedFileName'>Uploaded File:- <u class='uploadMultfileName'>" + allFiles[indx].name + "</u></div>");
                }
                if (NewAllSettings.progressBars == null) {
                    NewAllSettings.progressBars = [];
                }
                NewAllSettings.progressBars.push(progressBarElement[0]);
                if (!NewAllSettings.isMobile && NewAllSettings.isDragNDrop) {
                    NewAllSettings.DragNDropHeight = NewAllSettings.DragNDropHeight + $(progressBarElement).height() +
                                                    $($(progressBarElement).nextAll(".uploadedFileName")[0]).height() + 55;
                    $(NewAllSettings.dragBox).stop().animate({ "height": NewAllSettings.DragNDropHeight + "px" }, "fast", "linear");
                }
                //debugger;
                $(NewAllSettings.triggeringDom).data("NewMultipleuploadOptionDate", NewAllSettings);
                ...
                if (crrntImgTempPath != null && NewAllSettings.allowPreview != null && NewAllSettings.allowPreview == true &&
                            (NewAllSettings.previewContainer == null || typeof NewAllSettings.previewContainer === "undefined" ||
                                    $(NewAllSettings.previewContainer).length <= 0)) {
                ...
                else if (crrntImgTempPath != null && NewAllSettings.allowPreview != null && NewAllSettings.allowPreview == true &&
                            NewAllSettings.previewContainer != null && typeof NewAllSettings.previewContainer !== "undefined") {
                    previewImgTag = $(NewAllSettings.previewContainer).find("img[preview='true']");
                    if (typeof previewImgTag === "undefined" || previewImgTag.length <= 0) {
                        $(NewAllSettings.previewContainer).append("<img src='' preview='true'/>");
                        previewImgTag = $(NewAllSettings.previewContainer).find("img[preview='true']");
                    }
                }
                if (crrntImgTempPath != null && previewImgTag != null) {
                    ...
                    $(previewImgTag).css({
                        "width": NewAllSettings.previewWidth,
                        "height": (NewAllSettings.previewHeight.replace(/\s+/g, "").trim() == "0px" ? "auto" : NewAllSettings.previewHeight)
                    });
                }
            }
...
function fn_laksUploader(allFiles, totalFiles) {
    if (fn_laksHandleUndefinedVariables(allFiles) == true) {
        for (file_index = 0; file_index < totalFiles ; file_index++) {
            if (NewAllSettings.onBeforeFileSend != null && typeof NewAllSettings.onBeforeFileSend !== "undefined") {
                NewAllSettings.onBeforeFileSend(NewAllSettings, totalFiles, file_index);
            }
            ...
            crrnt_xhrequest.xmlIndx = (NewAllSettings.progressBars.length - totalFiles + file_index);
            crrnt_xhrequest.upload.xmlIndx = (NewAllSettings.progressBars.length - totalFiles + file_index);
            if (xhrequest == null) {
                xhrequest = [];
            }
            ...
            crrnt_xhrequest.upload.onprogress = function (event) {
                ...
                var crrnt_progress = $(NewAllSettings.progressBars[(Math.round(crrnt_xhrequest_1.xmlIndx))]);
            ...
            crrnt_xhrequest.onreadystatechange = function () {
                ...
                if (typeof crrnt_xhrequest_1 !== "undefined" && crrnt_xhrequest_1 != null && crrnt_xhrequest_1.readyState == 4 && crrnt_xhrequest_1.status == 200) {
                    ...
                    var crrnt_progress = $(NewAllSettings.progressBars[crrntProgressBarIndx]);
                    if (typeof crrnt_progress !== "undefined" && $(crrnt_progress).length > 0) {
                        if (NewAllSettings.onEachFileComplete != null && typeof NewAllSettings.onEachFileComplete !== "undefined") {
                            NewAllSettings.onEachFileComplete(NewAllSettings, (crrnt_xhrequest_1.responseText).toString(), crrntProgressBarIndx);
                        }
                    }
                }
            }
            if (NewAllSettings.uploadPath != null) {
                crrnt_xhrequest.open("POST", NewAllSettings.uploadPath);

                crrnt_xhrequest.send(crrnt_formData);
            }
        }
        if (NewAllSettings.multiFile) {
            $(NewAllSettings.triggeringDom).val("Add More");
        }
        if (NewAllSettings.onAllUploadComplete != null && typeof NewAllSettings.onAllUploadComplete !== "undefined") {
            NewAllSettings.onAllUploadComplete(NewAllSettings);
        }
        xhrequest = null;
        DropEvent = null;
        FilesFromDropEvent = null;
...
function deleteUpload(domElement) {
    ...
    //debugger;
    var crrntSettings = $(triggeringDom).data("NewMultipleuploadOptionDate");
    if (xhrequest != null) {
    ...
    crrnt_progresstable.find("span").animate({ "width": "0%" }, "fast", function () {
        ...
        if (resetHeight) {
           ...
           // debugger;
            $(triggeringDom).data("NewMultipleuploadOptionDate", crrntSettings);
        }
