...
{
    public class TerritoryRightsMasterController : Controller
    {
        ...
        #region Constructor
        public TerritoryRightsMasterController(IWorkContext workContext)
        {
        ...
        #region Methods
        /// <summary>
        /// Method to get TerritoryRightsMaster
        /// </summary>
        /// <returns></returns>
        public ActionResult TerritoryRightsMaster()
        {
