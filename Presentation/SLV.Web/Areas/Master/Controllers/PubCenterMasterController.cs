...
{
    public class PubCenterMasterController : Controller
    {
        ...
        #region Constructor
        public PubCenterMasterController(IWorkContext workContext)
        {
        ...
        #region Methods
        /// <summary>
        /// Method to get PubCenterMaster
        /// </summary>
        /// <returns></returns>
        public ActionResult PubCenterMaster()
        {
