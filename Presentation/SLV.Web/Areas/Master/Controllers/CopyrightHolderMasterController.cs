...
{
    public class CopyrightHolderMasterController : Controller
    {
        ...
        #region Constructor
        public CopyrightHolderMasterController(IWorkContext workContext)
        {
        ...
        #region Methods
        /// <summary>
        /// Method to get CopyrightHolderMaster
        /// </summary>
        /// <returns></returns>
        public ActionResult CopyrightHolderMaster()
        {
