...
namespace SLV.Model.Common
{
    public  class AuthorModel
    {
        ...
        public string[] AuhtorDocument { get; set; }
        ...
        public string NomineeUploadFile { get; set; }

        public string[] NomineeDocumentName { get; set; }

        public int[] NomineeDocumentIds { get; set; }

        public string NomineeDocumentId { get; set; }
