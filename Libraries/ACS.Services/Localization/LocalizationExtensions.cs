...
namespace ACS.Services.Localization
{
    public static class LocalizationExtensions
    {
            ...
            where T : struct
        {
            ...
            string result = localizationService.GetResource(resourceName);
            ...
            ILocalizationService localizationService, ILanguageService languageService)
        {
            ...
            foreach (var lang in languageService.GetAllLanguages(true))
            {
                ...
                var lsr = localizationService.GetLocaleStringResourceByName(resourceName);
            ...
            where T : IPlugin
        {
            ...
            var resource = localizationService.GetLocaleStringResourceByName(resourceName);
