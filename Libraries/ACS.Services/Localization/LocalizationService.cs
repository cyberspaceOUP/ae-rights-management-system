...
namespace ACS.Services.Localization
{
    /// <summary>
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_ALL_KEY = "ACS.lsr.all-{0}";
        private const string LOCALSTRINGRESOURCES_ALL_KEY1 = "ACS.lsr.all";
        ...
        /// {1} : resource key
        /// </remarks>
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY = "ACS.lsr.{0}-{1}";
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY1 = "ACS.lsr.{0}";

        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LOCALSTRINGRESOURCES_PATTERN_KEY = "ACS.lsr.";
        ...
        {
            string key = LOCALSTRINGRESOURCES_ALL_KEY1;
        ...
        //    else
        //    {
        //        _workContext.WorkingLanguage = _languageService.GetLanguageById(2);
        //        return GetResource(resourceKey, _workContext.WorkingLanguage.Id);
        //    }
        ...
        public virtual string GetResource(string resourceKey)
        {
            ...
            {
                //gradual loading
                string key = string.Format(LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY1, resourceKey);
