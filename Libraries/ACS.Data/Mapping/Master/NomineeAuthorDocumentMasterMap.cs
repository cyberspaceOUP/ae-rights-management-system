...
namespace ACS.Data.Mapping.Master
{
    ...
    public partial class NomineeAuthorDocumentMasterMap : EntityTypeConfiguration<NomineeAuthorDocumentMaster>
    {
        public NomineeAuthorDocumentMasterMap()
        {
            this.ToTable("NomineeAuthorDocumentMaster");
            this.HasKey(a => a.Id);
            ...
            this.HasRequired(usl => usl.AuthorMaster)
                .WithMany(s => s.NomineeAuthorDocumentMaster)
