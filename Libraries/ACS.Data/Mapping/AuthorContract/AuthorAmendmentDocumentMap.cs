...
namespace ACS.Data.Mapping.AuthorContract
{
    ...
    class AuthorAmendmentDocumentMap : EntityTypeConfiguration<AuthorAmendmentDocument>
    {
        public AuthorAmendmentDocumentMap()
        {
            this.ToTable("AuthorAmendmentDocumentMaster");
            this.HasKey(a => a.Id);
            this.Property(a => a.Documentname).IsOptional().HasMaxLength(400);
            this.Property(a => a.documentfile).IsOptional().HasMaxLength(100);
