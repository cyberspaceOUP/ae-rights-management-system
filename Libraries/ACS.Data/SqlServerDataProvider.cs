...
using ACS.Core.Data;
using ACS.Data.Initializers;

namespace ACS.Data
{
    class SqlServerDataProvider : IDataProvider
    {
        #region Utilities
...
#pragma warning disable 0618
        ...
        public virtual void SetDatabaseInitializer()
        {
            ...
            var initializer = new CreateTablesIfNotExist<ACSObjectContext>(tablesToValidate, customCommands.ToArray());
