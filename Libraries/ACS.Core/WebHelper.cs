...
namespace ACS.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetCurrentIpAddress()
        {
            ...
            //  ADDED BY SACHIN SAXENA 20/05/2015
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new ACSException("nopCommerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["ACS.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["ACS.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["ACS.IsPOSTBeingDone"] = value;
            }
        }

        public virtual string GetUser_IP()
        {
            string VisitorsIPAddr = string.Empty;
            VisitorsIPAddr = HttpContext.Current.Request.ServerVariables["HTTP_X_FORWARDED_FOR"];
            if (VisitorsIPAddr == "" || VisitorsIPAddr == null)
