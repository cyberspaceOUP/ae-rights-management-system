...
{
    public partial class AuthorMaster :BaseEntity , ILocalizedEntity 
    {
        ...
        public virtual GeographicalMaster AuthorCompanyCountry { get; set; }
        public virtual GeographicalMaster AuthorCompanyState { get; set; }
        public virtual GeographicalMaster AuthorCompanyCity { get; set; }


        public virtual GeographicalMaster AuthorAffCompanyCountry { get; set; }
        public virtual GeographicalMaster AuthorAffCompanyState { get; set; }
        public virtual GeographicalMaster AuthorAffCompanyCity { get; set; }

        public virtual GeographicalMaster AuthorBenfiCompanyCountry { get; set; }
        public virtual GeographicalMaster AuthorBenfiCompanyState { get; set; }
        public virtual GeographicalMaster AuthorBenfiCompanyCity { get; set; }

        public virtual GeographicalMaster AuthorDetCompanyCountry { get; set; }
        public virtual GeographicalMaster AuthorDetCompanyState { get; set; }
        public virtual GeographicalMaster AuthorDetCompanyCity { get; set; }
      ...
      //  public virtual AuthorDepartment AuthorDepartment { get; set; }

        public virtual ICollection<AuhtorDocument> AuhtorDocument { get; set; }

        public virtual ICollection<NomineeAuthorDocumentMaster> NomineeAuthorDocumentMaster { get; set; }
