//Create By Ankush On 17/08/2016
...
{
    public partial class PermissionsOutboundPaymentTagging : BaseEntity, ILocalizedEntity
    {
       public int? ContractId { get; set; }
        ...
        public int PermissionsOutboundMasterId { get; set; }
